...
**Scaffolded. Themed shell and admin schema in place, no screens yet.**
...
| Application | Scaffolded — tokens, signature component, Payload admin. No screens |
...
Phase 0 screens are next — home, sobre, listings, contact. Each gets its own task doc.
...
src/components/         signature (the CRECI lockup) and shared composites
...
Two route groups because Payload's admin needs its own root layout. Nothing else lives at the
top of `src/app/`.
